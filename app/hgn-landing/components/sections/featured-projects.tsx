...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/app/hgn-landing/components/ui/card";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="group hover:shadow-lg transition-shadow overflow-hidden p-0">
            <div className="relative h-56 w-full">
              <Image
                src="/hgn-landing/images/featured-projects/OHF.jpg"
          ...
          <Card className="group hover:shadow-lg transition-shadow overflow-hidden p-0">
            <div className="relative h-56 w-full">
              <Image
                src="/hgn-landing/images/featured-projects/brand-factory.jpg"
          ...
          <Card className="group hover:shadow-lg transition-shadow overflow-hidden p-0">
            <div className="relative h-56 w-full">
              <Image
                src="/hgn-landing/images/featured-projects/grenseveien.jpeg"
